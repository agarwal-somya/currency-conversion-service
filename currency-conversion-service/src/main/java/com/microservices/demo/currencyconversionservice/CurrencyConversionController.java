...
public class CurrencyConversionController {
			...
			public CurrencyConversionBean convertCurrent(@PathVariable String from , @PathVariable String to, @PathVariable BigDecimal quantity)
			{ 
		...
		return new CurrencyConversionBean(response.getId() , from ,to ,response.getConversionMultiple() , quantity, 
			...
			public CurrencyConversionBean convertCurrentFeign
